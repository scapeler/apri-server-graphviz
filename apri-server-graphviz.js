/*
** Module: apri-server-graphviz
**
** System module for graphviz service handling client requests for graphviz diagrams.
**
*/
...
var imagesLocalPath = systemFolderParent +'/graphviz/images/';
...
// handling of neato commando on dot files
app.post('/'+apriConfig.systemCode+'/graphviz/neato/', function(req, res) {
  // get graphviz dot file and execute graphviz neato command
  // output to /graphviz/images/.
});

// handling of different filetypes in graphviz images folder
app.get('/'+apriConfig.systemCode+'/graphviz/images/*.png', function(req, res) {
  try {
